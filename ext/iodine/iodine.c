...
void Init_iodine(void) {
  ...
  IODINE_CONST_ID_STORE(IODINE_CURRENT_ID, "current");
  IODINE_CONST_ID_STORE(IODINE_JOIN_ID, "join");
  IODINE_CONST_ID_STORE(IODINE_ALIVE_ID, "alive?");
  ...
  IODINE_CONST_ID_STORE(IODINE_QUERY_ID, "query");
