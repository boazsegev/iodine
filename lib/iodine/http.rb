...
class Iodine
  ...
  class Http
    ...
    #
    # For some reason, the following methods do not show in the documentation. The links refer to the same methods as they apply to the {Iodine::Protocol} mixin: {Iodine::Protocol#run}, {Iodine::Protocol#run_every}, {Iodine::Protocol#run_after}, {Iodine::Protocol#defer}.
